...
function createTable(aluno) {
    ...
    divErro.innerHTML = "";
    if(nomeAluno.value.length > 2 && sobrenomeAluno.value.length > 2 && idadeAluno.value >= 3 && idadeAluno.value <= 100 && nota1.value <= 10 && nota1.value.trim() !== "" && nota2.value <= 10 && nota2.value.trim() !== "" && nota3.value <= 10 && nota3.value.trim() !== ""){
